...
import { ArrowLeft, Camera, Facebook, Instagram, Mail, Plus, Save, Trash2, Video, X } from 'lucide-react';
...
export function ProfileEdit() {
  ...
  const { user, signOut, refreshAll, goTo } = useStore();
      ...
      <Card className="p-5 sm:p-6">
        <div className="space-y-3.5">
          <div className="flex flex-col items-center gap-3">
            ...
            >
              <Avatar src={avatarUrl} name={name || user.name} size={110} ring />
          ...
          <div className="grid grid-cols-2 gap-3">
            <Field label={t('facebookLabel')}>
              <div className="relative">
                <Facebook size={16} className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 text-ink-400" />
                <Input
                  value={facebookUrl}
            ...
            <Field label={t('instagramLabel')}>
              <div className="relative">
                <Instagram size={16} className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 text-ink-400" />
                <Input
                  value={instagramUrl}
