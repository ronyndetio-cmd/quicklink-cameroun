...
/** Lucide has no brand glyphs, so the real WhatsApp mark is inlined here. */
export function WhatsAppIcon({ size = 16, className }: { size?: number; className?: string }) {
  return (
    <svg viewBox="0 0 32 32" width={size} height={size} className={className} fill="currentColor" aria-hidden>
      <path d="M16.004 3C9.377 3 4 8.373 4 15c0 2.34.657 4.53 1.8 6.395L4 29l7.86-1.756A11.94 11.94 0 0 0 16.004 27C22.63 27 28 21.627 28 15S22.63 3 16.004 3Zm0 21.75c-1.98 0-3.827-.55-5.404-1.505l-.388-.23-4.66 1.04 1.02-4.55-.253-.397A9.71 9.71 0 0 1 6.25 15c0-5.38 4.375-9.75 9.754-9.75 5.38 0 9.746 4.37 9.746 9.75s-4.367 9.75-9.746 9.75Zm5.34-7.29c-.293-.147-1.734-.855-2.003-.953-.269-.098-.465-.147-.66.147-.196.293-.758.953-.93 1.148-.171.196-.342.22-.635.073-.293-.147-1.238-.456-2.358-1.454-.872-.777-1.46-1.737-1.632-2.03-.171-.293-.018-.452.129-.598.132-.132.293-.343.44-.514.147-.171.196-.293.294-.489.098-.196.049-.367-.025-.514-.073-.147-.66-1.59-.904-2.177-.238-.573-.48-.495-.66-.504l-.562-.01c-.196 0-.514.073-.783.367-.269.293-1.026 1.002-1.026 2.443s1.05 2.834 1.197 3.03c.147.196 2.067 3.157 5.008 4.428.7.302 1.246.483 1.672.618.702.223 1.341.192 1.846.116.563-.084 1.734-.709 1.978-1.394.245-.685.245-1.271.171-1.394-.073-.122-.269-.196-.562-.343Z" />
    </svg>
  );
}
