...
const RAW: [string, (typeof REGIONS)[number], number, number][] = [
  ...
  ['Zoétélé', 'Sud', 3.15, 11.85],
  ['Ngoulemakong', 'Sud', 3.35, 11.35],
  // additional towns — approximate coordinates, same disclaimer as above
  ['Galim-Tignère', 'Adamaoua', 7.9, 12.9],
  ['Mayo-Baléo', 'Adamaoua', 8.28, 12.9],
  ['Martap', 'Adamaoua', 6.783, 13.667],
  ['Kontcha', 'Adamaoua', 7.967, 12.233],
  ['Dir', 'Adamaoua', 8.15, 13.55],
  ['Bokito', 'Centre', 4.567, 11.15],
  ['Ngog-Mapubi', 'Centre', 4.15, 10.75],
  ['Efok', 'Centre', 4.567, 11.767],
  ['Ndikinimeki', 'Centre', 4.75, 10.55],
  ['Ngoyla', 'Est', 3.2, 13.05],
  ['Messamena', 'Est', 3.983, 13.667],
  ['Dimako', 'Est', 4.483, 13.567],
  ['Moloundou', 'Est', 2.033, 15.183],
  ['Mandjou', 'Est', 4.55, 13.75],
  ['Makary', 'Extrême-Nord', 12.633, 14.45],
  ['Fotokol', 'Extrême-Nord', 12.383, 14.183],
  ['Goulfey', 'Extrême-Nord', 12.35, 14.883],
  ['Zina', 'Extrême-Nord', 11.933, 14.733],
  ['Blangoua', 'Extrême-Nord', 12.517, 14.783],
  ['Bekoko', 'Littoral', 4.166, 9.65],
  ['Ngambe', 'Littoral', 3.95, 10.65],
  ['Rey Bouba', 'Nord', 8.667, 14.183],
  ['Bourha', 'Nord', 9.6, 13.75],
  ['Nwa', 'Nord-Ouest', 6.633, 11.283],
  ['Mbiame', 'Nord-Ouest', 6.35, 10.783],
  ['Babessi', 'Nord-Ouest', 5.95, 10.55],
  ['Batcham', 'Ouest', 5.65, 10.383],
  ['Eyumojock', 'Sud-Ouest', 5.75, 9.133],
  ['Ekondo-Titi', 'Sud-Ouest', 4.633, 8.9],
  ['Upenguen', 'Sud-Ouest', 4.9, 9.15],
];
